 ...
 <form class="form-horizontal" role="form">
    <div class="row">
        ...
        <div class="col-sm-6 col-lg-4">
            ...
            <div class="col-md-8"><input type="text" class="form-control" id="nombre_sector" placeholder="Sector"></div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-4">
        <div class="form-group"><label for="sector_ciudad" class="col-md-4 control-label">Ciudad:</label>
            <div class="col-md-8">
                <select id="sector_ciudad">                
                </select>
  ...
  <div class="row">
    <div class="col-sm-6 col-lg-4">
      <div>
          <div class="col-md-8">
            <div>
            <button id="guardar_sector" class="btn btn-primary">Guardar</button>
            <button id="actualizar_sector" class="btn btn-primary" disabled>Actualizar</button>
          </div>  
          </div>
      </div>
    </div>
